...
h: Чого ми взагалі *навчилися*? Я *були* дурні, мої "дузі" *дійсно* використовували мене, і ми майже, бляха, *вмерли*.
...
b: Ми пройшли чеез тяжкі події. Можливо, травму або нехтуванн. Ось, чому я іноді надто реагую і роблю:
...
h: Наступні п'ять хвилин звучатимуть дуже паскудно, але The next five minutes are going to sound super cheesy, but let's fake it 'til we make it.
...
[Ти правію Тож, давай захистимо нас.](#act4_harm_skills)
...
h: Протягом кількох днів кінолог поступово підвищує гучність, коди собака не переборює свій страх грому.
...
b: Я хочу переконатися, що ти заповниш ту глибоку людську потребу приналежності...

`bb({ eyes:"sad_u" });`

b: Але я переживаю, що всі, хто нас знали, - *справжніх нас* - втекли налякані від нас.
...
[Я погоджуюсь: давай попрацюємо над нашою соціалізацією.](#act4_alone_skills)

[Думаю, уніш люди нас люблять. Давай дізнаємось?](#act4_alone_experiment)
...
h: Або почати кращі соціальні звички, як планувати час з друзями або ходити регулярно на заходи?
...
[Хіба ц не зробть нас *схильними до маніпуляцій?*](#act4_alone_skills_manipulated)
...
b: Звучить текст з мотиваційного постера.
...
h: Окей, думаю, ми поговорили про всі стрхи тепер.
