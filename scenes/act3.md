...
h2: Точніше, у дві точки - мою праву і ліву амигдали.
...
r: Вона - не наш друг. Це скажений звір, якого треба або *приспати*,
...
h: Дехто кидається до роботи.

`hong({ body:"look_down", eyes:"look_down" });`

h: Дехто - до сексу, наркотиків і постійного гортання стрічки у Фейсбук.
...
h: Ми могли уникнути стількох проблем, ти, великий пухнастий довбо^йоб^. Чого ж ти не усвідомив того раніше?...
...
b: Є різниця між захисником і наглядачем у в'язниці, і я перетнув межу.
...
h: Так, ну, це була тупа ідея, у будь-якому випадку.
