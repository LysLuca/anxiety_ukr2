...
b: Гравець буде розчарований, закриє цю вкладку, видалить операційку, а тоді ми--
...
b: Бачиш, людино? Я твій вірний сторожовий вовк!
...
h: знаєш, певно, час глянути, що там у телефоні.
...
{{if _.fifteencigs}}
b: П'ятнадцять цигарок на день, людино! 15!
{{/if}}
...
{{if _.fifteencigs}}
b: Все, що ми робимо, це ридаємо в кутку про те, що самотність така ж вбивча, як і 15 цигарок на день.
{{/if}}
...
h: Оу, фотки з минулої ночі. То *ось*, що це за щотижневі вечірки.
...
b: У 2003 на Род-Айленді у клубі сталася пожежа, і паніка змусила людей створити тисняву біля дверей. 280 осіб згоріли заживо-
...
b: Ми - причина повстання фашизму на руїнах демократії!
...
b: Ну, інші завжди ігнорують *нас*, тому
...
b: Це що, додаток для знайомств?

`hong({eyes:"annoyed"})`

h: Ні, це не для знайомств. Просто спосіб знайти нов--
...
b: Безладні стосунки можуть заповнити пустку в мозку,

b: але вони ніколи не заповнять пустку...
...
b: Як твій вірний сторожовий вовк, я завжди на сторожі від небезпек і зроблю все, щоб вберегти тебе.
...
{{if _.act1g=="dont"}}
h: До речі, САМЕ ТОМУ, що ти не хочеш.
{{/if}}
...
h: Тепер дай мені поїсти цю канапку у ^йобаній^ тиші.
...
[{БІЖИ: Згорнися клубочком і плач!}](#act1i_cry) `Game.OVERRIDE_CHOICE_LINE=true`
...
b: Увесь світ сповнений небезпек!
